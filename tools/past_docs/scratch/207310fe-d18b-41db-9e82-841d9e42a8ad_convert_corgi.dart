...
void main() {
  final imagePath = 'C:\\Users\\Abdullah\\.gemini\\antigravity\\brain\\207310fe-d18b-41db-9e82-841d9e42a8ad\\media__1782461063573.jpg';
  ...
  // Add small padding (e.g. 5 pixels)
  final padding = 12;
  ...
  // 11: Color(0xFFF7F8FF) -> White fur (K)
  // 12: Color(0xFF12131A) -> Black outline / eyes (L)
  // 14: Color(0xFF7A4E2D) -> Brown shadow fur (N)
  // 32: Color(0xFFD78348) -> Orange / golden fur (f)
  // 42: Color(0xFFFFE7B5) -> Light cream / peach highlights (p)
  // 8: Color(0xFFFF7AC8) -> Pink tongue (H)
  // 13: Color(0xFF8D99AE) -> Ground shadow / Gray (M)
  final colorMap = {
    11: [247, 248, 255], // White
    12: [18, 19, 26],     // Black
    14: [122, 78, 45],    // Brown
    32: [215, 131, 72],   // Orange
    42: [255, 231, 181],  // Cream
    8: [255, 122, 200],   // Pink
    13: [141, 153, 174],  // Gray
  };
  ...
  print('\n=== Color Runs ===');
  // Make sure each count is a multiple of 5 (required by the game's engine!)
