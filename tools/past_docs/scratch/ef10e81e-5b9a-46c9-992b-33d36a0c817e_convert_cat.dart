...
void main() {
  final imagePath = 'C:\\Users\\Abdullah\\.gemini\\antigravity\\brain\\ef10e81e-5b9a-46c9-992b-33d36a0c817e\\media__1782392347196.jpg';
  ...
  // LevelData color values from LevelData class
  final colorMap = {
    1: [255, 77, 103],    // 0xFFFF4D67
    2: [66, 165, 255],    // 0xFF42A5FF
    3: [66, 232, 138],    // 0xFF42E88A
    4: [255, 212, 71],    // 0xFFCNTD447 -> 0xFFFFD447
  ...
  // We want to exclude background color from mapping to dot (empty) if it's transparent, 
  // but since this image has a pink gradient background, we can map the pink background to a specific background color 
  // or leave it as colored pixels. Let's see what fits best.
  // The background of the cat is a pink gradient: [255, 122, 200] (8) or [255, 77, 103] (1).
  // Let's print out the grid.
  ...
  for (int y = 0; y < 48; y++) {
    ...
    for (int x = 0; x < 48; x++) {
      ...
      int closestId = 12; // default black
      ...
      // If the color matches the background pink (e.g. colorId 8 or 1) and is near the border, we can make it empty '.' 
      // but actually having the full colored cat with the pink background makes it a beautiful full 48x48 drawing!
      // Let's just output the character.
