...
void main() {
  ...
  // Tight crop: no padding (padding = 0)
  final padding = 0;
  ...
  bool isWhiteBg(int x, int y) {
    ...
    final g = pixel.g.toInt();
    final b = pixel.b.toInt();
    // Return true for very light pixels (representing original white background)
  ...
  // Run flood fill from corners and edges to mark background as transparent
